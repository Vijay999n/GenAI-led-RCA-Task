...
if __name__ == "__main__":
        ...
        parser.add_argument("--summary_column", default="summary", help="Column name in incidents CSV for incident descriptions")
        ...
        for description in incidents[args.summary_column]:
            # Find RCA
           
            rca_entry, score= find_rca(description, knowledge_base, model)
            ...
            if rca_entry:
              ...
              suggestion = get_llm_suggestion(description)
              clean_text = suggestion.replace("*", "")
